...
//   setTimeout(() => {
//     if ((pokemons.find((obj) => obj.name === filter) === undefined)) {
//       return callback(new Error('Não temos esse pokémon para você :('), null);
//     }
//     const pokemon = pokemons.find((obj) => obj.name === filter);
...
// getPokemonDetails('Charmander', console.log);
