...
- [Wikiqube - Compilador fonte a fonte (Transpilador)](https://pt.zahn-info-portal.de/wiki/source-to-source_compiler)
...
- [Recapitulação sobre sistema de tipos](https://app.betrybe.com/course/real-life-engineer/typescript/static-typing-and-generics#recapitulacao-sobre-o-sistema-de-tipos)
