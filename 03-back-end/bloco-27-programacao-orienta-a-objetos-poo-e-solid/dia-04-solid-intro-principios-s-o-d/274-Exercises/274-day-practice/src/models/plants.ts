...
// eslint-disable-next-line import/extensions
import IOpsInfo from '../interfaces/OpsInfo';
...
class Plants {
  private PLANTS_PATH = path.join(__dirname, './database/plantsData.json');

  private OPS_INFO_PATH = path.join(__dirname, './database/opsInfo.json');
